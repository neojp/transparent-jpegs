...
<body>
	<header>
		...
		<p>Fork on <a href="https://github.com/neojp/transparent-jpeg" target="_blank">Github.com</a></p>

		<pre><code><?php echo htmlentities('<img src="landscape.jpg" data-original="landscape.png" data-mask="landscape-mask.png">'); ?></code></pre>
	...
	<section id="landscape">
		...
		<p><img src="landscape.jpg" data-original="landscape.png" data-mask="landscape-mask.png"></p>
	</section>
	...
	<section id="cristalab">
		...
		<p><img src="cristalab.jpg" data-original="cristalab.png" data-mask="cristalab-mask.png"></p>
	</section>
	...
	<script>
		$(document).ready( function() {	
			$('img[data-mask]').each(create_alpha_jpeg);
		});
	</script>
</body>
</html>